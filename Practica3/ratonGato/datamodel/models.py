...
class Move(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        occupied = [int(self.game.cat1), int(self.game.cat2), int(self.game.cat3), int(self.game.cat4), int(self.game.mouse)]

        if int(self.target) not in occupied:
...
class UserProfile(models.Model):
    username = models.OneToOneField(User, primary_key=True, on_delete=models.CASCADE, default="user")
